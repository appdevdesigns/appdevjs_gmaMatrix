...
(function() {
    ...
    var gmaClientMeasurementMatrixRADSetup = function() {
        ...
        $.when(initProcess).done(function () {
            ...
            OpenAjax.hub.publish("ad.gmaMatrix.matrix.setup", {});
    ...
    var subscriptionID = OpenAjax.hub.subscribe('ad.gmaMatrix.matrix.radsetup',gmaClientMeasurementMatrixRADSetup);
