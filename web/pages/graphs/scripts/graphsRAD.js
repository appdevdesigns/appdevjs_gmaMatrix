...
(function() {
    ...
    var graphsRADSetup = function() {
        ...
        $.when(initProcess).done(function () {
            ...
            OpenAjax.hub.publish("ad.gmaMatrix.graphs.setup", {});
    ...
    subscriptionID = OpenAjax.hub.subscribe('ad.gmaMatrix.graphs.radsetup',graphsRADSetup);
